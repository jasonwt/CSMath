namespace NumericArrays.Virtual.Mathematics.Binary {
    ...
    public class AdditionArray<T> : NumericArray<T>, IMathematicsArray<T>
        where T : struct, IComparable, IComparable<T>, IConvertible, IEquatable<T> {

        #region Private Fields
        private readonly INumericArray _leftArray;
        private readonly INumericArray _rightArray;
        #endregion

        #region Protected Constructors
        public AdditionArray(INumericArray leftArray, INumericArray rightArray) :
            base(
        ...
        public AdditionArray(INumericArray<T> leftArray, INumericArray rightArray) :
            this((INumericArray)leftArray, rightArray) {
        }
        #endregion
        ...
        public override INumericArray<T> Clone() => new AdditionArray<T>(_leftArray, _rightArray);
        #endregion
