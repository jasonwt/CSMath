namespace NumericArrays.Virtual.Mathematics.Binary {
    ...
    public class PowerArray<T> : NumericArray<T>, IMathematicsArray<T>
        ...
        public override T this[int linearIndex] {
            get {
                ...
                return (T) Math.Pow(_leftArray[linearIndex], _rightArray[linearIndex]).CastToArrayValueType(ValueType);
            }
        ...
        public override INumericArray<T> Clone() => new PowerArray<T>(_leftArray, _rightArray);
        #endregion
