namespace NumericArrays.Virtual.Mathematics.Binary {
    ...
    public class ModuloArray<T> : NumericArray<T>, IMathematicsArray<T>
        ...
        public ModuloArray(INumericArray leftArray, INumericArray rightArray) :
            base(
        ...
        public override INumericArray<T> Clone() => new ModuloArray<T>(_leftArray, _rightArray);
        #endregion
