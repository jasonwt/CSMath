namespace NumericArrays.Virtual.Reductions {
    ...
    public class ArgMinArray<T> : NumericArray<T>, IReductionArray<T>
        ...
        public ArgMinArray(INumericArray sourceArray, int? axis) :
        ...
        public override T this[int linearIndex] {
            ...
            get {
                ...
                double argMinValue = _sourceArray[start];
                int argMinIndex = 0;
                ...
                return (T)argMinIndex.CastToArrayValueType(ValueType);
            }
        ...
        public override INumericArray<T> Clone() => new ArgMinArray<T>(_sourceArray, _axis);
        #endregion
