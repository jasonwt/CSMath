namespace NumericArrays.Virtual.Reductions {
    ...
    public class ProductArray<T> : NumericArray<T>, IReductionArray<T>
        ...
        public ProductArray(INumericArray sourceArray, int? axis) :
        ...
        public override T this[int linearIndex] {
            ...
            get {
                ...
                return (T)valueSum.CastToArrayValueType(ValueType);
            }
        ...
        public override INumericArray<T> Clone() => new ProductArray<T>(_sourceArray, _axis);
        #endregion
