namespace NumericArrays.Virtual.Reductions
{
    ...
    public class SumArray<T> : NumericArray<T>, IReductionArray<T>
        ...
        public SumArray(INumericArray sourceArray, int? axis) :
        ...
        public override INumericArray<T> Clone() => new SumArray<T>(_sourceArray, _axis);
        #endregion
