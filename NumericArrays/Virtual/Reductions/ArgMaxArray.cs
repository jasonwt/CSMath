namespace NumericArrays.Virtual.Reductions {
    ...
    public class ArgMaxArray<T> : NumericArray<T>, IReductionArray<T>
        ...
        public ArgMaxArray(INumericArray sourceArray, int? axis) :
        ...
        public override T this[int linearIndex] {
            ...
            get {
                ...
                double argMaxValue = _sourceArray[start];
                int argMaxIndex = 0;

                for (int j = 1, i = start + _axisStep; i < end; i += _axisStep, j++)
                {
                ...
                return (T)argMaxIndex.CastToArrayValueType(ValueType);
            }
        ...
        public override INumericArray<T> Clone() => new ArgMaxArray<T>(_sourceArray, _axis);
        #endregion
